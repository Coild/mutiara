    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-5">
                    @if (isset($start))
                        <form action="{{ route('export.riwayat_grosir') }}" method="post">
                            <div class="row">
                                @csrf
                                <input type="hidden" name="filter" value="1">
                                <input type="hidden" name="start_date" class="form-control" value="{{ $start }}"
                                    required />
                                <input type="hidden" name="end_date" class="form-control" value="{{ $end }}"
                                    required />
                                <div class="col-md-2">
                ...
                <div class="col-md-5">
                    <form action="{{ route('grosir.riwayat_filter') }}" method="post">
                        <div class="row">
                            @csrf
                            <input type="hidden" name="filter" value="1">
                            <div class="col-md-5">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('edit_payment_grosir') }}" method="POST">
                        @csrf
